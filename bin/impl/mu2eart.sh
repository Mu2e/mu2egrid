...
export masterfhicl="$CONDOR_DIR_INPUT/${MU2EGRID_MASTERFHICL:?'Error: MU2EGRID_MASTERFHICL not set'}"
export userscript=${MU2EGRID_USERSCRIPT:-''}
if [ -n "${MU2EGRID_INPUTLIST}" ]; then MU2EGRID_INPUTLIST="$CONDOR_DIR_INPUT/$MU2EGRID_INPUTLIST"; fi
